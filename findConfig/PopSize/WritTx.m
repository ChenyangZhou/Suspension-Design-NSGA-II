function [x,fval,exitflag,output,population,score] = WritTx(nvars,lb,ub,PopInitRange_Data,PopulationSize_Data,Generations_Data,StallGenLimit_Data, TolFun_Data, MaxFunEvals_Data, MaxIter_Data,TolX_Data,TolCon_Data, CrossoverFraction_Data,PFraction)
