...
Excel = actxserver('Excel.Application');
  Excel.Visible = 1;
  Workbook = Excel.Workbooks.Open('K:\b1\vemireddy\studis\Zhou\05_Tool and downloaded mfile\01Programming using Matlab\For writing\PopSize\PopSize.xlsm');
...
tic
     PopulationSize_Data =(Popsize+1)*50;
...
c = clock;
save([date '_' num2str(c(4)) num2str(c(5)) '_PopSizeNoFG' num2str(PopulationSize_Data) '.mat']);
end
