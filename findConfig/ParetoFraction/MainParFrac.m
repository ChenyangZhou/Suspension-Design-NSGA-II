...
Excel = actxserver('Excel.Application');
  Excel.Visible = 1;
  Workbook = Excel.Workbooks.Open('K:\b1\vemireddy\studis\Zhou\05_Tool and downloaded mfile\01Programming using Matlab\For writing\ParetoFraction\ParetoFrac.xlsm');
...
c = clock;
save([date '_' num2str(c(4)) num2str(c(5)) '_PFracNoFG' num2str(ParFraNum) '_.mat']);
end
