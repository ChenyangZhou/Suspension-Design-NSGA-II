...
Excel = actxserver('Excel.Application');
  Excel.Visible = 1;
  Workbook = Excel.Workbooks.Open('K:\b1\vemireddy\studis\Zhou\05_Tool and downloaded mfile\01Programming using Matlab\For writing\FGoalorNot\FGoalorNot.xlsm');
...
tic
      MaxFunEvals_Data =500+500*MaxEv;
     
[x,fval,exitflag,output,population,score] = WritTxForFg(nvars,lb,ub,PopInitRange_Data,PopulationSize_Data,Generations_Data,StallGenLimit_Data, TolFun_Data, MaxFunEvals_Data, MaxIter_Data,TolX_Data,TolCon_Data,CrossoverFraction_Data,PFraction);
...
c = clock;
save([date '_' num2str(c(4)) num2str(c(5)) 'FGMaxEva2try' num2str(MaxEv) '.mat']);
end
